    ...
    public static Screen screen(Screen parent) {
        return YetAnotherConfigLib.create(CONFIG, ((defaults, config, builder) -> builder
                ...
                .category(ConfigCategory.createBuilder()
                        ...
                        .option(Option.createBuilder(boolean.class)
                                .name(Text.translatable("viewmodel.category.arm.enable"))
                                .description(OptionDescription.of(Text.translatable("viewmodel.category.general.enabled.desc")))
                                .binding(defaults.affectArm, () -> config.affectArm, newVal -> config.affectArm = newVal)
                                .controller(TickBoxControllerBuilder::create)
                                .build())
                        .option(Option.createBuilder(float.class)
                                .name(Text.translatable("viewmodel.category.arm.posArmX"))
                                .description(OptionDescription.of(Text.translatable("viewmodel.category.arm.posArmX.desc")))
                                ...
                                .build())
                        .option(Option.createBuilder(float.class)
                                .name(Text.translatable("viewmodel.category.arm.posArmY"))
                                .description(OptionDescription.of(Text.translatable("viewmodel.category.arm.posArmY.desc")))
                                ...
                                .build())
                        .option(Option.createBuilder(float.class)
                                .name(Text.translatable("viewmodel.category.arm.posArmZ"))
                                .description(OptionDescription.of(Text.translatable("viewmodel.category.arm.posArmZ.desc")))
                                ...
                                .build())
                        .option(Option.createBuilder(float.class)
                                .name(Text.translatable("viewmodel.category.arm.rotArmX"))
                                .description(OptionDescription.of(Text.translatable("viewmodel.category.arm.rotArmX.desc")))
                                ...
                                .build())
                        .option(Option.createBuilder(float.class)
                                .name(Text.translatable("viewmodel.category.arm.rotArmY"))
                                .description(OptionDescription.of(Text.translatable("viewmodel.category.arm.rotArmY.desc")))
                                ...
                                .build())
                        .option(Option.createBuilder(float.class)
                                .name(Text.translatable("viewmodel.category.arm.rotArmZ"))
                                .description(OptionDescription.of(Text.translatable("viewmodel.category.arm.rotArmZ.desc")))
                ...
                .category(ConfigCategory.createBuilder()
                        ...
                        .option(Option.createBuilder(boolean.class)
                                ...
                                .binding(defaults.animEnable, () -> config.animEnable, newVal -> config.animEnable = newVal)
                                .controller(TickBoxControllerBuilder::create)
                                .build())
                        .option(Option.createBuilder(boolean.class)
